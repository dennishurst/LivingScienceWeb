<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NewsIndex.aspx.cs" Inherits="News_NewsIndex" %>
                        ...
                        <li>
                                <div class="clearfix">
                                    ...
                                    <div class="extra-wrap">
                                        ...
                                        <p>Posted by&nbsp;<a href="#">Lance Davis</a><br></p>
                                    </div>
                                </div>
                                <div class="thumb-pad5">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <a href="/site/News/STEMParentMeeting.aspx" class="btn btn-primary"><span>Read more</span><img src="/site/img/more_arrow.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
