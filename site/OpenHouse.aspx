...
<div class="main">
  ...
  <div class="container padBot1"> 
        ...
        <article class="span8 pull-left">
            ...
            <h3>Summer 2013 Open House Dates:</h3>
            ...
            <table>
            <tr><td>Your Name (*) </td><td><input type="text" name="your-name" value="" size="40" /></td>
            <tr><td>Your Email (*) </td><td><input type="text" name="your-email" value="" size="40" /></td>
            <tr><td>Grade Level of Child</td><td><input type="text" name="your-grade" value="" size="40" /></td>
